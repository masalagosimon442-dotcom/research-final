    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="researcherNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 mt-2 mt-lg-0">
                <li class="nav-item">
                    <a class="nav-link <?= activeNav('dashboard.php') ?>" href="<?= BASE_URL ?>views/researcher/dashboard.php">📊 Dashboard</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= BASE_URL ?>views/researcher/compounds/index.php">💊 Compounds</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= BASE_URL ?>views/researcher/research_search.php">🔬 Research</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= BASE_URL ?>views/researcher/organisms/index.php">🌿 Organisms</a>
                </li>
                <li class="nav-item dropdown">
