...
<nav class="navbar navbar-expand-lg navbar-dark bg-success sticky-top shadow" role="navigation" aria-label="Main navigation">
    <div class="container-fluid">
        ...
        <!-- Collapsible nav links (hamburger controls this) -->
        ...
        <!-- ROW 1: Logo + Title (left) | Icons (right) -->
        <div class="d-flex align-items-center w-100 py-1">

            <!-- Logo + Title -->
            <a class="navbar-brand d-flex align-items-center gap-2 me-auto" href="<?= BASE_URL ?>views/researcher/dashboard.php" id="navLogo" style="text-decoration:none">
                <div class="d-flex align-items-center justify-content-center rounded-circle"
                     style="width:40px;height:40px;background:#fff;box-shadow:0 2px 8px rgba(0,0,0,0.2);padding:4px;flex-shrink:0">
                    <img src="<?= BASE_URL ?>assets/img/logo.svg" alt="Logo" style="width:100%;height:100%">
                </div>
        ...
        <!-- ROW 2: Hamburger (left, mobile only) + Nav links -->
        <div class="d-flex align-items-center w-100">
            <!-- Hamburger on LEFT - only visible on mobile -->
            <button class="navbar-toggler border-0 d-lg-none me-2 p-1" type="button"
                    data-bs-toggle="collapse" data-bs-target="#researcherNav"
                    aria-controls="researcherNav" aria-expanded="false" aria-label="Toggle navigation"
